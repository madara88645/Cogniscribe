  ...
  return (
    <section className="vp-glass vp-glow rounded-2xl border border-[var(--vp-border)] p-4">
      ...
      {hasText ? (
        ...
        <div className="flex min-h-20 items-center justify-center rounded-xl border border-dashed border-[var(--vp-border)] bg-[#0b1327]/50 p-4 text-center">
          <p className="text-sm italic text-[var(--vp-muted)]">No transcript yet. Press record to start dictating.</p>
        </div>
      )}
    </section>
  );
